...
describe('localStorageHelper.getExpiry', () => {
  it('returns new expiryTime from currentTime when given days', () => {
    expect(browserStorageHelper.getExpiry({ unit: 'days', value: 1 }, 1)).toEqual(1000 * 60 * 60 * 24 + 1);
  });
  it('returns new expiryTime from currentTime when given minutes', () => {
    expect(browserStorageHelper.getExpiry({ unit: 'minutes', value: 1 }, 1)).toEqual(1000 * 60 + 1);
  });
});
